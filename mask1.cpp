////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Mon Jul 3 11:30:12 2017
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQTable(p,DB,0,2,2);
  pvSetGeometry(p,DB,3,9,645,585);
  pvSetFont(p,DB,"Roboto",12,0,0,0,0);

  pvQTable(p,table,0,4,2);
  pvSetGeometry(p,table,711,33,231,186);
  pvSetFont(p,table,"Roboto",12,0,0,0,0);

  pvQLabel(p,LIFE_COUNTER,0);
  pvSetGeometry(p,LIFE_COUNTER,726,291,348,39);
  pvSetText(p,LIFE_COUNTER,pvtr("lifecounter"));
  pvSetFont(p,LIFE_COUNTER,"Roboto",12,0,0,0,0);

  pvQLabel(p,WRITE_ERROR,0);
  pvSetGeometry(p,WRITE_ERROR,723,411,318,42);
  pvSetText(p,WRITE_ERROR,pvtr("write error"));
  pvSetFont(p,WRITE_ERROR,"Roboto",12,0,0,0,0);

  pvQLabel(p,READ_ERROR,0);
  pvSetGeometry(p,READ_ERROR,726,345,348,42);
  pvSetText(p,READ_ERROR,pvtr("read error"));
  pvSetFont(p,READ_ERROR,"Roboto",12,0,0,0,0);
