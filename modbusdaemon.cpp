...
rlSerial       serial;
rlSharedMemory shm("/srv/automation/shm/modbus.shm",12);
...
int main(int ac, char **av)
{
  ...
  if(ac > 0) av0 = av[0];
  first = 1;
  while(serial.openDevice(SERIAL_DEVICE,B9600,1,1000,8,1,rlSerial::NONE) < 0)
  {
